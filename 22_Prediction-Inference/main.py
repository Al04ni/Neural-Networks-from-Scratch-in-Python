...
# Visualize first sample from X_test
# Undo the scaling and flattening you applied:
# sample = X_test[0].reshape(28, 28)  # shape back to 28×28
# sample = (sample * 127.5) + 127.5    # invert your earlier scaling

# plt.imshow(sample, cmap='gray')
# plt.title(f"Sample 0, Label: {y_test[0]}")
# plt.axis('off')
# plt.show()
...
confidences1 = model.predict(X_test[:5])
predictions1 = model.output_layer_activation.predictions(confidences1)
# print(predictions)
...
for prediction1 in predictions1:
    print(fashion_mnist_labels[prediction1])
...
confidences2 = model.predict(image_data)

# Get prediction instead of confidence levels
predictions2 = model.output_layer_activation.predictions(confidences2)

# Get label name from label index
prediction2 = fashion_mnist_labels[predictions2[0]]
