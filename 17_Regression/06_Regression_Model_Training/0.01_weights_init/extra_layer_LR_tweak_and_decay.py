...
# Create optimizer
# optimizer = Optimizer_Adam(learning_rate=0.01, decay=1e-3) # Starter - Not good
# optimizer = Optimizer_Adam(learning_rate=0.05, decay=1e-3) # Bigger - Not good
optimizer = Optimizer_Adam(learning_rate=0.005, decay=1e-3) # Final - Most optimal
