...
# Create optimizer
# optimizer = Optimizer_SGD(decay=1e-2) # 0.01
optimizer = Optimizer_SGD(decay=1e-3) # 0.001
...
#       ----- Animations -----
# Live SGD Optimization for neural network with a Decaying (1e-2) Learning Rate.
# https://nnfs.io/zuk/

# Live SGD Optimization for neural network with a slower Decaying (1e-3) Learning Rate.
# https://nnfs.io/muk/
