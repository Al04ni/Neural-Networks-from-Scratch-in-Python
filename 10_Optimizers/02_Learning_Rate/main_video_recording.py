...
# Set up video recording at 60 FPS
writer = FFMpegWriter(fps=60, codec="h264", metadata=dict(title='Training Process', artist='Matplotlib'), bitrate=2000)
video_filename = 'training_process.mp4'

with writer.saving(fig, video_filename, dpi=100):  # Adjust dpi as needed
